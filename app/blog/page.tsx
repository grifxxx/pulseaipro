...
export const metadata: Metadata = {
  title: "Статьи об инвестициях: налоги, ИИС, ОФЗ и биржа",
  description:
    "Справочник для частного инвестора: ИИС-3 и вычеты, ОФЗ, шорт, биржевой стакан, дивидендная отсечка, налог на криптовалюту. С расчётами и таблицами.",
  keywords: [
