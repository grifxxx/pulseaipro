...
export const metadata: Metadata = {
  title: "Лента: акции и криптовалюты в центре внимания сегодня",
  description:
    "Какие акции США, российские акции и криптовалюты сегодня в новостях — короткий ИИ-разбор по каждой: что произошло, почему это заметно, какие риски, ссылки на источники. Обновляется три раза в день.",
